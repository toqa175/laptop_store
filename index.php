    ...
    <div id="novaHeroCarousel" class="carousel slide carousel-fade" data-bs-ride="carousel">
        ...
        <div class="carousel-inner">
            ...
            <div class="carousel-item active position-relative"
                 style="min-height: 80vh; background: url('https://images.unsplash.com/photo-1603302576837-37561b2e2302?q=80&w=1920&auto=format&fit=crop') center/cover no-repeat;">

                <div class="position-absolute top-0 start-0 w-100 h-100"
                     style="background: linear-gradient(90deg, rgba(15, 23, 42, 0.95) 0%, rgba(15, 23, 42, 0.75) 50%, rgba(15, 23, 42, 0.3) 100%); z-index: 1;">
                </div>

                <div class="container-fluid px-lg-5 position-relative z-2 h-100 d-flex align-items-center py-5"
                    ...
                    <div class="row w-100 py-5">
                        ...
                        <div class="col-12 col-md-8 col-lg-6">
                            ...
                            <span class="badge bg-danger bg-opacity-20 text-danger border border-danger border-opacity-25 px-3 py-2 rounded-pill fw-bold text-uppercase mb-3"
                            ...
                            <div class="d-flex flex-wrap gap-3">
                                ...
                                <a href="/laptop-store/products/index.php?category=gaming"
                                   class="btn btn-primary btn-lg rounded-3 fw-bold px-4 py-2.5 fs-6">
                                    Explore Gaming
                                    <i class="bi bi-arrow-right ms-1"></i>
                                </a>

                                <a href="/laptop-store/products/index.php"
                                   class="btn btn-outline-light btn-lg rounded-3 fw-bold px-4 py-2.5 fs-6">
                                    View All Products
                                </a>
            ...
            <div class="carousel-item position-relative"
                 style="min-height: 80vh; background: url('https://images.unsplash.com/photo-1588872657578-7efd1f1555ed?q=80&w=1920&auto=format&fit=crop') center/cover no-repeat;">
                ...
                <div class="container-fluid px-lg-5 position-relative z-2 h-100 d-flex align-items-center py-5"
                    ...
                    <div class="row w-100 py-5">
                        ...
                        <div class="col-12 col-md-8 col-lg-6">
                            ...
                            <span class="badge bg-warning bg-opacity-20 text-warning border border-warning border-opacity-25 px-3 py-2 rounded-pill fw-bold text-uppercase mb-3"
                                  style="letter-spacing: 0.08em; font-size: 0.75rem;">
                                SMART VALUE
                            </span>
                            ...
                            <div class="d-flex flex-wrap gap-3">
                                ...
                                <a href="/laptop-store/products/index.php?category=budget"
                                   class="btn btn-primary btn-lg rounded-3 fw-bold px-4 py-2.5 fs-6">
                                    View Budget Laptops
                                    <i class="bi bi-arrow-right ms-1"></i>
                                </a>
            ...
            <!-- Slide 3 -->
            <div class="carousel-item position-relative"
                 style="min-height: 80vh; background: url('https://images.unsplash.com/photo-1525547719571-a2d4ac8945e2?q=80&w=1920&auto=format&fit=crop') center/cover no-repeat;">
                ...
                <div class="container-fluid px-lg-5 position-relative z-2 h-100 d-flex align-items-center py-5"
                    ...
                    <div class="row w-100 py-5">
                        ...
                        <div class="col-12 col-md-8 col-lg-6">
                            ...
                            <span class="badge bg-info bg-opacity-20 text-info border border-info border-opacity-25 px-3 py-2 rounded-pill fw-bold text-uppercase mb-3"
                                  style="letter-spacing: 0.08em; font-size: 0.75rem;">
                                ULTRABOOKS
                            </span>
                            ...
                            <div class="d-flex flex-wrap gap-3">
                                ...
                                <a href="/laptop-store/products/index.php?category=business"
                                   class="btn btn-primary btn-lg rounded-3 fw-bold px-4 py-2.5 fs-6">
                                    Shop Ultrabooks
                                    <i class="bi bi-arrow-right ms-1"></i>
                                </a>
        ...
        <div class="container-fluid px-lg-5 position-absolute bottom-0 start-0 end-0 z-3 pb-4">
            ...
            <div class="d-flex justify-content-between align-items-center">
                ...
                <div class="carousel-indicators position-static m-0 justify-content-start">
                    ...
                    <button type="button"
                            data-bs-target="#novaHeroCarousel"
                            data-bs-slide-to="0"
                            class="active"
                            aria-current="true"
                            aria-label="Slide 1">
                ...
                <div class="d-flex gap-2">
                    ...
                    <button class="btn btn-light rounded-circle p-0 d-inline-flex align-items-center justify-content-center shadow-sm"
                            type="button"
                            data-bs-target="#novaHeroCarousel"
                            data-bs-slide="prev"
            ...
            <?php if (!empty($categories)): ?>
                ...
                <?php foreach ($categories as $category): ?>
                    ...
                    <div class="col-12 col-sm-6 col-lg-3">
                        ...
                        <a href="/laptop-store/products/index.php?category=<?= urlencode($category['slug']) ?>"
                            ...
                            <div class="card bg-dark text-white border-0 shadow rounded-4 overflow-hidden h-100">
                                ...
                                <?php if (!empty($category['image'])): ?>
                                    ...
                                    <img
                                        ...
                                        style="height: 420px; opacity: 0.55;"
                                    >
                                ...
                                <?php else: ?>
                                    ...
                                    <img
                                        ...
                                        class="card-img object-fit-cover"
                                        alt="<?= htmlspecialchars($category['name']) ?>"
                                        style="height: 420px; opacity: 0.4;"
                                    >
...
<section id="products" class="py-5 bg-light">
    ...
    <div class="container-fluid px-lg-5 py-4">
        ...
        <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-end mb-5">
            ...
            <a href="/laptop-store/products/index.php"
               class="text-primary fw-bold text-decoration-none mt-3 mt-md-0 fs-6">
                View All Products
                <i class="bi bi-arrow-right"></i>
            </a>
...
<section id="partners" class="py-5 bg-white border-top border-bottom">
    ...
    <div class="container py-2">
        ...
        <p class="text-center text-primary fw-bold small text-uppercase mb-4"
        ...
        <div class="row g-5 align-items-center">
            ...
            <div class="col-lg-7">
                ...
                <h2 class="display-5 fw-bold text-dark mb-4">
                    Your Trusted Laptop Destination Since 2015
                </h2>
                ...
                <div class="card border-0 bg-light rounded-4 p-4 p-md-5 shadow-sm">
                    ...
                    <div class="d-flex align-items-start gap-3 mb-4">
                        ...
                        <div>
                            ...
                            <p class="text-muted small mb-0">
                                All our laptops come with full manufacturer warranty and local service center support.
                            </p>
                    ...
                    <div class="d-flex align-items-start gap-3 mb-4">
                        ...
                        <div>
                            ...
                            <p class="text-muted small mb-0">
                                Safe and express door-to-door shipping across all Egyptian governorates.
                            </p>
                    ...
                    <div class="d-flex align-items-start gap-3">
                        ...
                        <div>
                            ...
                            <p class="text-muted small mb-0">
                                Our expert team helps you pick the perfect specs for your budget and workflow.
                            </p>
